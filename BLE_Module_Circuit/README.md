1. Between TX pin of microcontroller and Rx pin of BLE module a SN74LVC1G125 buffer is connected this is done to step down the voltage from 5v to 3.3v as BLE works on 3.3v.
2. Tx pin of BLE is connected to Rx pin of Atmega256, basically BLE is connected on UART1 of Atmega256.
